...
const postCard = [
    ...
    {
        textmain: "The orange is the fruit of the citrus species Citrus × sinensis in the family Rutaceae, native to China.[1] It is also called sweet orange, to distinguish it from the related Citrus × aurantium, referred to as bitter orange.",
        image: "https://soappotions.com/wp-content/uploads/2017/10/orange.jpg",
        text: "Orange",
        id: 2
    },
    {   
        textmain: "Kiwifruit (often abbreviated as kiwi outside Australia and New Zealand), or Chinese gooseberry, is the edible berry of several species of woody vines in the genus Actinidia.[1][2] The most common cultivar group of kiwifruit",
        image:"https://www.wonderopolis.org/wp-content/uploads/2012/10/Kiwi_shutterstock_84220885-1.jpg",
        text: "Kiwi",
        id: 3
    },
    {
        textmain: "An apple is a sweet, edible fruit produced by an apple tree (Malus domestica). Apple trees are cultivated worldwide and are the most widely grown species in the genus Malus. ",
